...
const permissionLabels: Record<keyof EmployeePermissions, string> = {
  ...
  createRewards: 'إضافة مكافآت',
  updateRewards: 'تحديث المكافآت',
  deleteRewards: 'حذف المكافآت',
  viewSchedules: 'عرض الجداول',
  createSchedules: 'إضافة جداول',
  updateSchedules: 'تحديث الجداول',
  deleteSchedules: 'حذف الجداول',
  viewReviews: 'عرض التقييمات',
  createReviews: 'إضافة تقييمات',
  updateReviews: 'تحديث التقييمات',
  deleteReviews: 'حذف التقييمات',
  viewPayments: 'عرض المدفوعات',
  createPayments: 'إضافة مدفوعات',
  updatePayments: 'تحديث المدفوعات',
  deletePayments: 'حذف المدفوعات',
  viewCoupons: 'عرض الكوبونات',
  createCoupons: 'إضافة كوبونات',
  updateCoupons: 'تحديث الكوبونات',
  deleteCoupons: 'حذف الكوبونات',
  viewDiscounts: 'عرض الخصومات',
  createDiscounts: 'إضافة خصومات',
  updateDiscounts: 'تحديث الخصومات',
  deleteDiscounts: 'حذف الخصومات',
  viewGiftCards: 'عرض البطاقات الهدايا',
  createGiftCards: 'إضافة بطاقات هدايا',
  updateGiftCards: 'تحديث بطاقات هدايا',
  deleteGiftCards: 'حذف بطاقات هدايا'
};
