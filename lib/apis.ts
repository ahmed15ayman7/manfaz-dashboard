...
const API_ENDPOINTS = {
  auth: {
    register: (params: Record<string, any>) => appendQueryParams('/authAdmin/register', params),
    login: (params: Record<string, any>) => appendQueryParams('/authAdmin/login', params),
    changePassword: (params: Record<string, any>) => appendQueryParams('/authAdmin/change-password', params),
    resendVerificationCode: (params: Record<string, any>) => appendQueryParams('/authAdmin/resend-verification-code', params),
    verifyAccount: (params: Record<string, any>) => appendQueryParams('/authAdmin/verify-account', params),
    refreshToken: (params: Record<string, any>) => appendQueryParams('/authAdmin/refresh', params),
  },
  users: {
  ...
  employeeActivities: {
    ...
    getByEmployee: (employeeId: string, params: Record<string, any>) => appendQueryParams(`/employee-activities/employees/${employeeId}`, params),
    getAuditLogs: (params: Record<string, any>) => appendQueryParams('/employee-activities/audit-logs', params),
  },
  reports: {
